...
/** Generated from the Tabler filled icon "affiliate". Run `pnpm generate` to update. */
export const AffiliateFilledIcon = (props: IconProps) => (
  <Icon {...props}>
...
AffiliateFilledIcon.displayName = "AffiliateFilledIcon";
