...
/** Generated from the Tabler filled icon "device-floppy". Run `pnpm generate` to update. */
export const DeviceFloppyFilledIcon = (props: IconProps) => (
  <Icon {...props}>
...
DeviceFloppyFilledIcon.displayName = "DeviceFloppyFilledIcon";
