/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: f24a82444fbdbbb133b51f57ce46e0ea)
// Runtime types generated with workerd@1.20260820.1 2026-08-23 
interface __BaseEnv_CloudflareEnv {
	GOVDATA_LIVE_CACHE_ENABLED: "true";
	GOVDATA_LIVE_REPLAY: "false";
	...
	TAGO_STATION: string;
	TAGO_ROUTE: string;
	TAGO_BUS_LOCATION: string;
	TAGO_ARRIVAL: string;
	NMC_HOSPITAL: string;
	MOIS_POPULATION: string;
	HEAT_SHELTER: string;
	GOVDATA_CONTAINER: DurableObjectNamespace<import("./worker").GovDataContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "GovDataContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOVDATA_LIVE_CACHE_ENABLED" | "GOVDATA_LIVE_REPLAY" | "LIVE_API_TIMEOUT_SECONDS" | "GOVDATA_AI_ENABLED" | "GOVDATA_AI_PROVIDER" | "OPENAI_API_KEY" | "OPENAI_API_MODEL" | "OPENAI_REASONING_EFFORT" | "GOVDATA_OPENAI_TIMEOUT_SECONDS" | "DATA_GO_KR_KEY" | "TAGO_STATION" | "TAGO_ROUTE" | "TAGO_BUS_LOCATION" | "TAGO_ARRIVAL" | "NMC_HOSPITAL" | "MOIS_POPULATION" | "HEAT_SHELTER">> {}
}
